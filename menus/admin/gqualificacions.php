<?php
session_start();
include('../../funcions/gqualificacions/seleccio/config.php');
include('../../funcions/gqualificacions/seleccio.php');
...
<head>
    ...
    <title>Gestió de qualificacions</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <script type="text/javascript">
     $(document).ready(function() {
             ...
             $("#parent_cat").change(function() {
                     ...
                     $.get('../../funcions/gqualificacions/seleccio/loadsubcat.php?parent_cat=' + $(this).val(), function(data) {
                             $("#sub_cat").html(data);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h2>Gestió de qualificacions </h2>   
                    </div>
                </div>              
                 <!-- /. FILA  -->
                <hr/>
                <div class="col-lg-6 col-md-6">
                    <div class="table-responsive">
                        ...
                        <form method="POST" action='gqualificacions.php'>
                        ...
                        <?php
                            ...
                            if(isset($_POST['sub_cat'])){
                                qualificacio($_POST['parent_cat'],$_POST['sub_cat']);
                            }
