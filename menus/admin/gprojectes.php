<?php
session_start();
include('../../funcions/gprojectes/seleccio/config.php');
include('../../funcions/gprojectes/seleccio.php');
    ...
    <script type="text/javascript">
     $(document).ready(function() {
             ...
             $("#parent_cat").change(function() {
                     ...
                     $.get('../../funcions/gprojectes/seleccio/loadsubcat.php?parent_cat=' + $(this).val(), function(data) {
                             $("#sub_cat").html(data);
            ...
            <div id="page-inner">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="table-responsive">
                        ...
                        <form method="POST" action='gprojectes.php'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="parent_cat" id="parent_cat">
                                            ...
                                            <option value="<?php echo $row['idcurs']; ?>"><?php echo $row['2']." | ".$row['1']; ?></option>
                                            <?php endwhile; ?>
                                        </select>
                                    </td>
                                </tr>
                        ...
                        <?php
                            ...
                            if(isset($_POST['sub_cat'])){
                                llistaprojectes($_POST['parent_cat'],$_POST['sub_cat']);
                            }
                        ...
                        <table class='table'>
                            <tr>
                                <td><a class='btn btn-success' href='../../form/fprojectes/addprojecte.php'> Crear projecte </a></td>
                            </tr>
                        </table>
