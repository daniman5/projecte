    ...
    if(isset($_SESSION['usuari'])){
        ...
        if($resultat['tipus'] == 'admin'){
            ...
            while($datos = mysqli_fetch_array($llistaSQL,MYSQLI_ASSOC)){
                ...
                echo "<td align='center'><a href='../../funcions/gusuaris/delusuari.php?dnom=".$datos['usuari']."'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td></tr></tbody>";
